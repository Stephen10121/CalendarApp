...
function filterJob(jobs: JobsStruct[], userId: number, jobClicked: (job: JobType, myJob?: boolean) => any) {
    let myJobs = [];
...
export default function RenderMyJobs({ jobs, userId, jobClicked }: { jobs: JobsStruct[], userId: number, jobClicked : (job: JobType, myJob?: boolean) => any }) {
